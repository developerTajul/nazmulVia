...
$value = $wpdb->get_results("SELECT * FROM $questions_table");
$_SESSION['quiz'] =  $value;

$current_quiz_no = $_SESSION['current_quiz_no'] = 0;
...
echo "<pre>";
print_r($_SESSION['quiz'][$single_question]);
echo "</pre>";
...
ob_start(); ?>
	...
	<form action="" method="post">
		<table>
			...
			<tr>
				<td><label for="sUsername"><?php echo $value[0]->question_text; ?></label></td>

				<!-- nested loop for options -->
				

				<td><input type="radio" name="answer" value="1"><?php echo $value[0]->answer1; ?></td>
				<td><input type="radio" name="answer" value="2"><?php echo $value[0]->answer2; ?></td>
				<td><input type="radio" name="answer" value="3"><?php echo $value[0]->answer3; ?></td>
				<td><input type="radio" name="answer" value="4"><?php echo $value[0]->answer4; ?></td>
